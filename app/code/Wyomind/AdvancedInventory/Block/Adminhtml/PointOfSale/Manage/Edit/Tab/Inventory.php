        ...
        implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            'label' => __('Stock status message'),
            'name' => 'stock_status_message',
            'note' => 'Message that displays on the product page when the product is available in this stock',
                ]
        );
        ...
        $this->setChild(
                'form_after', $this->getLayout()->createBlock('Magento\Backend\Block\Widget\Form\Element\Dependence')
                        ...
                        ->addFieldMap('stock_status_message', 'stock_status_message')
                        ->addFieldDependence('stock_status_message', 'manage_inventory', 1)
