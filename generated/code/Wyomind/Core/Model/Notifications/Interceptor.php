...
class Interceptor extends \Wyomind\Core\Model\Notifications implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'notice');
        if (!$pluginInfo) {
            return parent::notice($msg);
        } else {
            return $this->___callPlugins('notice', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getValues()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getValues', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'XML2Array');
        if (!$pluginInfo) {
            return parent::XML2Array($xml);
        } else {
            return $this->___callPlugins('XML2Array', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getIdentity');
        if (!$pluginInfo) {
            return parent::getIdentity();
        } else {
            return $this->___callPlugins('getIdentity', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSeverity');
        if (!$pluginInfo) {
            return parent::getSeverity();
        } else {
            return $this->___callPlugins('getSeverity', func_get_args(), $pluginInfo);
        }
    }
