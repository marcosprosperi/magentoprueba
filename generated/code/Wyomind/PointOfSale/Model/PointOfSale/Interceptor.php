...
class Interceptor extends \Wyomind\PointOfSale\Model\PointOfSale implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPlace');
        if (!$pluginInfo) {
            return parent::getPlace($id);
        } else {
            return $this->___callPlugins('getPlace', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPlacesByStoreId');
        if (!$pluginInfo) {
            return parent::getPlacesByStoreId($storeId, $onlyVisible);
        } else {
            return $this->___callPlugins('getPlacesByStoreId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCountries');
        if (!$pluginInfo) {
            return parent::getCountries($storeId);
        } else {
            return $this->___callPlugins('getCountries', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLastInsertedId');
        if (!$pluginInfo) {
            return parent::getLastInsertedId();
        } else {
            return $this->___callPlugins('getLastInsertedId', func_get_args(), $pluginInfo);
        }
    }
